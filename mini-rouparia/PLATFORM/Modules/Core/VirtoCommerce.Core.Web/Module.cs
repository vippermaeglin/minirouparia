...
namespace VirtoCommerce.CoreModule.Web
{
    public class Module : ModuleBase, ISupportExportImportModule
    {
        ...
        public override void PostInitialize()
        {
            ...
            shippingService.RegisterShippingMethod(() => new PagSeguroShippingMethod(moduleSettings.First(x => x.Name == "VirtoCommerce.Core.FixedRateShippingMethod.Rate"))
            {
                Name = "PagSeguro",
                Description = "Entrega via correios PAC (5  dias úteis)",
                LogoUrl = "https://stc.pagseguro.uol.com.br/pagseguro/i/logos/logo_pagseguro200x41.20160623111843695.png"

            });

            shippingService.RegisterShippingMethod(() => new ShippifyShippingMethod(moduleSettings.First(x => x.Name == "VirtoCommerce.Core.FixedRateShippingMethod.Rate"))
            {
                Name = "Shippify",
                Description = "Entrega via Shippify (1 dia útil)",
                LogoUrl = "https://shippify.co/panel_img/logo_big_login.png"
            ...
            {
                Name = "fixed rate",
                Description = "Buscar pessoalmente (combinar por email)",
                LogoUrl = "https://shippify.co/panel_img/logo_big_login.png"

            });

            paymentService.RegisterPaymentMethod(() => new PagSeguroPaymentMethod()
            {
                IsActive = true,
                Name = "PagSeguro API",
                Description = "Módulo de pagamento PagSeguro",
                LogoUrl = "https://stc.pagseguro.uol.com.br/pagseguro/i/logos/logo_pagseguro200x41.20160623111843695.png",
            });
